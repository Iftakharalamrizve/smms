    ...
    return (
        <Box className="mc-overview">
            <Section className="mc-overview-banner">
                <Container>
                    <Logo href="/" src={ data?.banner.logo } alt="logo" name="gPlex" className="lg" />
            ...
            <Section className="mc-overview-footer">
                <Heading as="h2">Do you want to inquiry about gPlex template?</Heading>
                <a 
                    href="https://themeforest.net/item/gPlex-react-admin-dashboard-template/40188968/support" 
                    target="_blank" 
                    rel="noopener noreferrer" 
                    className="mc-btn primary" 
                >
                ...
                <Text>gPlex | © Copyrights by <Text as="span">Mironcoder</Text></Text>
            </Section>
        </Box>
    )
}